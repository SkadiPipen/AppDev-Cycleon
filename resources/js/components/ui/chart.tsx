...
export const ChartSector = RechartsPrimitive.Sector
export const ChartCurve = RechartsPrimitive.Curve
export const ChartRectangle = RechartsPrimitive.Rectangle
